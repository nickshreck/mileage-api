...
app.post(
    ...
    async (req: Request, res: Response) => {
        ...
        const props = Object.assign(req.query, req.params, req.body);
        try {
            const results = await uploadFile(files, props.googleId);
            // console.log(results);
...
app.post("/googleDataTransfer", async (req, res) => {
    try {
        console.log(
            "hello you have been contacted from Lambda to tell you to run the googleTransfer",
            req.body
        );
